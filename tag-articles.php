    ...
    <div class="card-container">
      <?php
        ...
        // if(isset($_GET['id']) && $_GET['id']!='') {
          ...
          $articleQuery = " SELECT category.category_name, category.category_color,article.* FROM category,article 
          ...
          ORDER BY (
              ...
              AND tag_id IN (SELECT tag_id FROM user_tags WHERE user_id = $user_id)
          ) DESC;";
      ...
      <div class="pagination">
        <?php
          ...
          for($i = 1; $i <= $total_page; $i++) {
            ...
            echo '<a href="tag-articles.php?'.$cat_id.'page='.$i.'" class="'.$active.'">'.$i.'</a>';
          }
